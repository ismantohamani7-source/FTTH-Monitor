...
class RouterosAPI
{
     ...
     * @param string      $login      The RouterOS username
     * @param string      $password   The RouterOS password
     * @param int         $port       The RouterOS port (default 8728)
     * @param boolean     $useSSL     Use SSL connection (default false)
     *
     * @return boolean                If we are connected or not
     */
    public function connect($ip, $login, $password, $port = 8728, $useSSL = false)
    {
